...
if [ -z "$1" "$2" "$3"]; then
  echo "错误：请提供 Flutter SDK 的路径作为第一个参数。Flutter tag 作为第二个参数，如：flutter3.24.5_conch1.6.6,jdk路径作为第三个参数。"
...
Flutter_Tag=$2
JAVA_PATH=$3
echo $FLUTTER_SDK_PATH
echo $Flutter_Tag=$Flutter_Tag
echo $JAVA_PATH
